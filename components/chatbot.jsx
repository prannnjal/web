...
import { MessageCircle, X, Send, Bot, User, Sparkles, Zap, Settings, Mic, MicOff, Volume2, VolumeX, Phone } from 'lucide-react'
...
export default function Chatbot() {
  ...
  return (
    <>
      ...
      <div className="fixed bottom-4 right-4 sm:bottom-6 sm:right-6 z-50 flex flex-col items-center gap-4">
        {/* WhatsApp Button */}
        {!isOpen && (
          <a
            href="https://wa.me/918051216699"
            target="_blank"
            rel="noopener noreferrer"
            className="bg-green-500 hover:bg-green-600 text-white p-3 rounded-full shadow-lg transition-all duration-300 hover:scale-110 flex items-center justify-center relative group"
          ...
          <div className="relative bg-gradient-to-r from-gray-900 to-gray-800 p-3 sm:p-4 rounded-t-2xl border-b border-gray-700/50">
            ...
            <div className="mt-3 flex items-center justify-between">
              <div className="flex items-center space-x-2">
                ...
                <span className={`text-xs font-medium ${jarvisMode ? 'text-purple-400' : 'text-blue-400'
                  }`}>
